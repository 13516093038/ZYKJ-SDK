package com.bfwhxg.simaoaggregate.thirdparty;
...
import com.bfwhxg.simaoaggregate.simaogoppo.SimaoPlatformOppo;
import com.bfwhxg.simaoaggregate.simaogoppo.SimaoPlatformNativeOppo;
...
public class ZYAGInitializer {
    ...
    public static void registerPlatforms(Activity activity){
        ...
        SimaoAggregate.instance().registerPlatform(SimaoPlatformOppo.instance(), activity);
        SimaoAggregate.instance().registerPlatform(SimaoPlatformNativeOppo.instance(), activity);
    }
    ...
    public static void initBanner(String zoneName, Activity contentActivity){
        ...
        if (contentActivity.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT){
            ...
            bannerHeight = dp2px(contentActivity, 57);
        }
