...
import com.bfwhxg.spfan.simao4399.SimaoPlatform4399;
//import com.bfwhxg.spfan.simaohonor.SimaoPlatformHonor;
...
//        SimaoAggregate.instance().registerPlatform(SimaoPlatformHonor.instance(), activity);
        SimaoAggregate.instance().registerPlatform(SimaoPlatform4399.instance(), activity);
    }
